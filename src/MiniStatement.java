...
public class MiniStatement extends JFrame {
    ...
    public MiniStatement(String cardNo)
    {
       ...
       // setUndecorated(true);
        ...
        cardNumLabel.setText("Card Number: " + cardNum);
        cardNumLabel.setBounds(145,55,200,30);
  ...
  try {
   Conn con = new Conn();
//    String query="select * from login where Card_Num ='"+cardNum+"'";   
...
//    }
//            
    String query2 = "SELECT * FROM bank WHERE Card_Num = '" + cardNum + "' ORDER BY Date DESC LIMIT 5";
    ...
    System.out.println(e);
        ...
        miniLabel.setBounds(20,190,450,200);
        setVisible(true);

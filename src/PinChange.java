        ...
        else if(ae.getSource()==changeButton)
        {
            try{
                ...
                else if(!rpin.equals(npin))
                {
                    ...
                    Conn c= new Conn();
                   // String queryB="update bank set PIN='"+rpin+"' where Card_Num ='"+cardNo+"'";
                    String queryL="update login set PIN='"+rpin+"' where Card_Num ='"+cardNo+"'";
                    String queryS="update signup3 set PIN='"+rpin+"' where Card_Num ='"+cardNo+"'";
